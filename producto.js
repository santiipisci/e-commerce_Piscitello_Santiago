...
let pc_model = parseInt(window.location.search.split("=")[0])
const card = data.find((product) => product.pc_model === pc_model);
  console.log(card)

let productoo = `
<div class="card d-flex flex-column align-items-center" style="width: 18rem">
<img src="${card.imagen}"
alt="imagen ${card.titulo}"
style="object-fit: cover; width: 100%; height: 150px;"
    ...
    <div class="card-body d-flex flex-column">
        ...
        <p class="card-text">   
           Detalles:  ${card.detalle}
        </p>
        <p class="card-text">
           Precio: ${card.precio}
        </p>
        <p class="card-text">
           Disponibilidad: ${card.disponibilidad}
        </p>
